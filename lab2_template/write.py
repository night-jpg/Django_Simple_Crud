...
def write_learners():
    ...
    learner_john.save()
    learner_pedro = Learner(first_name='Pedro', last_name='Afonso', dob=date(1999, 10, 1),email="ppma.txt@gmail.com",location="Alfenas",
                           occupation='developer',
                           social_link='https://www.linkedin.com/pedro/')
    learner_pedro.save()
